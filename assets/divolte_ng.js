...
var LOGGING = false;
/** @define {string} */
// Overridden for a custom source (a divolte-collector.conf source with
// javascript.name = divolte_ng.js) - was 'divolte.js'.
var SCRIPT_NAME = 'divolte_ng.js';
/** @define {string} */
var EVENT_SUFFIX = 'csc-event';
/** @define {boolean} */
// Overridden for a custom source (javascript.auto_page_view_event =
// false) - was true.
